...
var cp_off = preload("res://Assets/Images/Buildings/Furnace.png")
var cp_on = preload("res://Assets/Images/Buildings/Furnace-On.png")
...
func _on_timer_timeout() -> void:
	...
	if progress > 0:
		return
	sprite.texture = cp_off
	food["data"] = Catalogue.smelting_reference[food["data"].itemID]
	if panel:
		panel.building_texture.texture = sprite.texture
		panel.food.update_slot(food["data"], 1)
	cooktime.stop()
